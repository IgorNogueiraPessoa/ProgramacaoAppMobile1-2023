...
fun addDataToDatabase(
    ...
    Column(
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite seu endereço") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black, fontSize = 15.sp),
            singleLine = true,
        )
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite seu bairro") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black, fontSize = 15.sp),
            singleLine = true,
        )
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite seu CEP") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black, fontSize = 15.sp),
            singleLine = true,
        )
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite sua cidade") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black, fontSize = 15.sp),
            singleLine = true,
        )
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite seu estado.") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black, fontSize = 15.sp),
            singleLine = true,
        )
        ...
        TextField(
            ...
            placeholder = { Text(text = "Digite seu celular.") },
            modifier = Modifier.fillMaxWidth(),
            textStyle = TextStyle(color = Color.Black, fontSize = 15.sp),
            singleLine = true,
        )
        ...
        Button(onClick = {
            ...
            Toast.makeText(context, "Cadastro de pessoa física realizado", Toast.LENGTH_SHORT).show()
        }) {
